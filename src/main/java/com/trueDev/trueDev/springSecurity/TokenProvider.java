...
import com.trueDev.trueDev.springSecurity.exception.InvalidTokenException;
...
public class TokenProvider {
    ...
    public TokenDto reissueAccessToken(String refreshToken) {
        ...
        String storedRefreshToken = redisUtil.find(userId)
        ...
        redisUtil.save(userId, newRefreshToken);
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        Long userId = extractUserId(claims);
        UserDetails principal = new JwtUserDetails(userId, claims.getSubject(), authorities);
    ...
    private Long extractUserId(Claims claims) {
        Number id = claims.get(USER_ID_KEY, Number.class);
        if (id == null) {
            throw new InvalidTokenException("Invalid_Token");
        }
        return id.longValue();
